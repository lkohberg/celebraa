        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.7 }}>
          ...
          <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
            ...
            <motion.div className="relative z-10 text-center px-4" initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1, delay: 0.3 }}>
              ...
              <p className="text-xl md:text-2xl italic" style={{ fontFamily: "var(--font-display)", color: event.hero_image_url ? "rgba(255,255,255,0.9)" : "hsl(30, 10%, 35%)" }}>{formattedDate}</p>
              {event.description && <p className="font-body text-sm mt-2 tracking-[0.15em] uppercase" style={{ color: event.hero_image_url ? "rgba(255,255,255,0.7)" : "hsl(30, 8%, 50%)" }}>{event.description}</p>}
            </motion.div>
            ...
            <div className="max-w-5xl mx-auto px-4">
              ...
              <div className="grid md:grid-cols-2 gap-12 max-w-3xl mx-auto">
                <div className="text-center">
                  <MapPin className="w-8 h-8 mx-auto mb-4" style={{ color: accent }} />
          ...
          <footer className="py-16 text-center" style={{ backgroundColor: "hsl(30, 30%, 98%)" }}>
            <h2 className="text-3xl mb-4" style={{ fontFamily: "'Great Vibes', cursive", color: accent }}>{names}</h2>
            <p className="font-body text-sm text-muted-foreground tracking-[0.15em] uppercase">{formattedDate.replace(/\s/g, " · ")}</p>
