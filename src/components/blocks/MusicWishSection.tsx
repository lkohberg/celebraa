    ...
    <section className="py-20 relative overflow-hidden">
      ...
      <div className="relative max-w-md mx-auto px-4">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-10">
          ...
          <p className="font-body text-sm text-muted-foreground mt-3">{l("musicWishSubtitle")}</p>
        </motion.div>

        <motion.div initial={{ opacity: 0, y: 10 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="bg-card/80 backdrop-blur-sm rounded-2xl p-6 border border-border/50 shadow-sm">
