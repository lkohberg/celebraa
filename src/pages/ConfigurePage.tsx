...
const ConfigurePage = () => {
  ...
  const isValid = form.title && form.date && form.time && form.eventLink && linkValid;
            ...
            <div className="sticky top-24">
              ...
              >
                <div className="p-8 text-center">
                  <p className="text-xs font-body uppercase tracking-widest mb-3 opacity-50"
                  ...
                  {form.description && (
                    <p className="font-body text-sm opacity-70 mt-2 max-w-xs mx-auto"
                      style={{ color: template.colors.accent }}>
                      {form.description}
                    </p>
                  )}
                  <div className="mt-6 space-y-2 max-w-xs mx-auto text-left">
                    {form.date && (
                      <div className="flex items-center gap-2 opacity-60 text-sm font-body"
                        style={{ color: template.colors.accent }}>
                    ...
                    {form.maxGuests && (
                      <div className="flex items-center gap-2 opacity-60 text-sm font-body"
                        ...
                        <span>max. {form.maxGuests} Gäste</span>
                      </div>
                    )}
                  </div>
          ...
          <div className="order-1 lg:order-2">
            ...
            <div className="space-y-6">
              <div>
                ...
                <Input
                  placeholder="z.B. Sarahs 30. Geburtstag"
                  value={form.title}
              ...
              <div>
                ...
                <Input
                  placeholder="z.B. Schloss Mirabell"
              ...
              <div className="border border-border rounded-lg p-5 space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(v) => updateField("rsvpEnabled", v)}
                  />
                </div>
                {form.rsvpEnabled && (
                  <>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        checked={form.menuSelection}
                        onCheckedChange={(v) => updateField("menuSelection", v)}
                      />
                    </div>
                  </>
                )}
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Select value={form.font} onValueChange={(v) => updateField("font", v)}>
                    ...
                    <SelectContent>
                      {fontOptions.map((f) => (
                        <SelectItem key={f.value} value={f.value} className="font-body">
                          {f.label}
                        </SelectItem>
                      ))}
                    </SelectContent>
              ...
              <div className="bg-secondary rounded-xl p-6 space-y-3">
                ...
                <Button
                  ...
                  disabled={!isValid}
                  onClick={() => navigate(`/success/${form.eventLink || "mein-event"}`)}
                >
