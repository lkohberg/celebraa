const en = {
  ...
  "packages.subtitle": "Select the features that suit your event",
  "packages.base": "Base event page",
  "packages.tabPackages": "Packages",
  "packages.tabCustom": "Custom",
  "packages.included": "Included",
  "packages.addonsLabel": "Add-ons",
  "packages.total": "Total",
  "packages.base.label": "Base",
  "packages.next": "Continue",
  "packages.selectHint": "Please select a package or at least one block",
  "packages.packageIncludes": "Includes",
  "packages.addonBlocks": "Additional blocks",

  // Blocks
  "blocks.timeline": "Timeline",
  "blocks.ourStory": "Our Story",
  "blocks.hotels": "Hotel Recommendations",
  "blocks.wishlist": "Gift Wishlist",
  "blocks.slideshow": "Photo Slideshow",
  "blocks.dressCode": "Dress Code",
  "blocks.menu": "Food Menu",
  "blocks.musicPro": "Music Pro (Song requests + DJ list)",
  "blocks.customMusic": "Custom Music on Open",
  "blocks.busShuttle": "Bus & Shuttle Times",
  "blocks.illustration": "Custom Illustration (AI-generated)",
  "blocks.products": "Products (Photos + Description)",
  "blocks.agenda": "Agenda",
  "blocks.sponsors": "Sponsors",
  "blocks.quiz": "Quiz about the Host",
  "blocks.gameVote": "Vote for Games",
  "blocks.wishMusic": "Wish Music",
  "blocks.bringList": "Bring List",

  // Packages
  "packages.weddingStarter": "Wedding Starter",
  "packages.weddingPlus": "Wedding Plus",
  "packages.weddingPremium": "Wedding Premium",
  "packages.businessStarter": "Business Starter",
  "packages.businessPro": "Business Pro",
  "packages.partyFun": "Party Fun",
  "packages.partyPlanner": "Party Planner",
  "packages.partyAllIn": "Party All-in",

  // Checkout Details Page
  "checkout.title": "Your contact details",
  "checkout.subtitle": "We need these to set up your event page",
  "checkout.firstName": "First name",
  "checkout.lastName": "Last name",
  "checkout.email": "Email address",
  "checkout.firstNamePlaceholder": "e.g. Anna",
  "checkout.lastNamePlaceholder": "e.g. Müller",
  ...
  "checkout.submit": "Pay securely now",
  "checkout.processing": "Redirecting to payment...",
  "checkout.orderSummary": "Order summary",
  "checkout.template": "Template",
  "checkout.package": "Package",
  "checkout.customBlocks": "Custom blocks",
  "checkout.stripe": "Payment via Stripe · Credit card, Apple Pay, Google Pay",
  "checkout.termsAccept": "I accept the",
  "checkout.back": "Back",

  // Order Confirmation Page
  "orderConfirmation.title": "Thank you for your order!",
  "orderConfirmation.subtitle": "Your event page will be ready within a few days.",
  "orderConfirmation.body": "You will find it in your dashboard or receive your dashboard link by email.",
  "orderConfirmation.email": "We will contact you at the email address you provided.",
  "orderConfirmation.backHome": "Back to home",
